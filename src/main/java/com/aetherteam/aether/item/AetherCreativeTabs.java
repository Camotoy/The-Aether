...
public class AetherCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, Aether.MODID);

    public static final RegistryObject<CreativeModeTab> AETHER_BUILDING_BLOCKS = CREATIVE_TABS.register(
            "building_blocks",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(AetherBlocks.HOLYSTONE_BRICKS.get()))
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_DUNGEON_BLOCKS = CREATIVE_TABS.register(
            "dungeon_blocks",
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_NATURAL_BLOCKS = CREATIVE_TABS.register(
            "natural_blocks",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_FUNCTIONAL_BLOCKS = CREATIVE_TABS.register(
            "functional_blocks",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_REDSTONE_BLOCKS = CREATIVE_TABS.register(
            "redstone_blocks",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_EQUIPMENT_AND_UTILITIES = CREATIVE_TABS.register(
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_ARMOR_AND_ACCESSORIES = CREATIVE_TABS.register(
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_FOOD_AND_DRINKS = CREATIVE_TABS.register(
            "food_and_drinks",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_INGREDIENTS = CREATIVE_TABS.register(
            "ingredients",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> AETHER_SPAWN_EGGS = CREATIVE_TABS.register(
            "spawn_eggs",
            () -> CreativeModeTab.builder()
